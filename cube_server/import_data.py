...
class summary(object):
    ...
    volume_week_usd = 0
    volume_month_usd = 0
    price_change_p_btc_day = 0
    price_change_p_btc_week = 0
    price_change_p_btc_month = 0
    price_change_p_btc_3month = 0
    price_change_p_btc_6month = 0
    price_change_p_btc_1year = 0
    price_change_p_usd_day = 0
    price_change_p_usd_week = 0
    price_change_p_usd_month = 0
    price_change_p_usd_3month = 0
    price_change_p_usd_6month = 0
    price_change_p_usd_1year = 0
